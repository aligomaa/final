        ...
        <div class="container-fluid">
            ...
            <div class="com-tabel col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table>
                    ...
                    <tr>
                        <th>{{$country->id}}</th>
                        <th><a href="{{route('show_governments',['id'=>$country->id])}}">{{$country->name}}</a></th>
                        <th>
            ...
            <div class="edit-sector1 col-md-4 col-sm-6 col-xs-12">
                <form method="post" action="{{route('add_country')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
