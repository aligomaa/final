        ...
        <div class="container-fluid">
            ...
            <div class="com-tabel col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                @foreach($government as $government)
                        <tr>
                            <th>{{$government->id}}</th>
                            <th><a href="{{route('show_cities',['id'=>$government->id])}}">{{$government->name}}</a></th>
                            <th>
            ...
            <div class="edit-sector1 col-md-4 col-sm-6 col-xs-12">
                <form method="post" action="{{route('add_government')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" name="country_id" value="{{$id}}" >
                    <input type="text"  name="name" placeholder="Government name ..">
